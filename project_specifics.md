...
All of the above must be versioned in a git repository hosted on GitHub. The submission must be shared with luca.terrazzan@boolean.careers via email and within the deadline specified at lesson and on Discord (usually two Sundays after the last lesson). It can either be a zipped Git repository or a link to a public GitHub repository (preferred).
Track
...
Take some time to read through the different columns and understand what kind of information is included. E.g.: what's the meaning of DATA_TYPE? What's the meaning of OBS_VALUE? Look online for additional clues to the different columns meaning, if needed!
